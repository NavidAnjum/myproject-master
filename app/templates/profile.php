			...
			<div class="row">
				...
				<div class="col-md-5 section">
						...
						<div class="status">
							...
							<div class="update_status"><p class="p">Update Status &nbsp;&#124; </p><input class="input" type="file" name="fileToUpload" id="fileToUpload">
							</div>
						 	...
						 	<div class="status_below">
								...
								<select>
								 ...
								 <button type="submit" class="button">Post</button></p>
				...
				<div class="col-md-5">
					...
					<h4 align="center">Friend lists</h4>
